...
$(function(){
  ...
  window.SubmitView = Backbone.View.extend({
    ...
    submitTemplate: Handlebars.compile(
    		'<div id="create-event">'+
            '<input id="new-title" placeholder="Title" type="text" />'+
          '  <input id="new-date" placeholder="Date & Time" type="text" />'+
          '  <input id="new-link" placeholder="Image Link" type="text" />'+
    ...
    render: function() {
      this.$('#content').html(this.submitTemplate());
    },
